    ...
    public function store(Request $request)
    {
        $data = $request->validate(
            [
                ...
                'images.*.images.*.image_url' => 'nullable|mimes:jpeg,png,jpg,gif,webp,bmp,svg,tiff,tif,ico,heic,heif|max:max:5120',
    ...
    public function update($id, Request $request)
    {
        $data = $request->validate(
            [
                ...
                'images.*.image_url' => 'sometimes|mimes:jpeg,png,jpg,gif,webp,bmp,svg,tiff,tif,ico,heic,heif|max:5120',
                'images.*.is_cover' => 'boolean',
                'is_cover'    => 'nullable|array',
                'is_cover.*'  => 'boolean',
            ]
